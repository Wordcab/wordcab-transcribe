...
async def health_check():
    ...
    <body class="h-screen mx-auto text-center flex min-h-full items-center justify-center bg-gray-100 text-gray-700">
        <div class="container mx-auto p-4">
            ...
            <p class="mt-16 text-gray-500">Want access? Contact us: <a class="text-blue-400 text-underlined" href="mailto:contact@deeptools.ai?subject=Access">contact@deeptools.ai</a></p>
            <a href="/docs">
