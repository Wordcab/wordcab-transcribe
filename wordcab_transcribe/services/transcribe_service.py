...
class TranscribeService:
    ...
    def __call__(
        self, filepath: str, source_lang: str, beam_size: Optional[int] = 5, word_timestamps: Optional[bool] = True
    ) -> List[dict]:
        """
        ...
        segments, _ = self.model.transcribe(
            filepath, language=source_lang, beam_size=beam_size, word_timestamps=word_timestamps
        )
